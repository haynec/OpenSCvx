...
| [Optax](https://github.com/google-deepmind/optax) | `rl` | JAX RL examples (`examples/rl/`): policy warm-start + learned dynamics via BYOF | ![rl](https://img.shields.io/badge/rl-optional%20extra-lightgrey) |
