...
time = ox.Time(initial=0.0, final=ox.Minimize(10.0), min=0.0, max=100.0)
...
problem.algorithm.lam_prox = 1e0  # Weight on the Trust Reigon
problem.algorithm.lam_cost = 1e-1  # Weight on the Minimal Time Objective
