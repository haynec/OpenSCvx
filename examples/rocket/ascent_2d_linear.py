...
p_dynamics_1_to_2 = ox.Cond(
    None, dynamics_1["p"], dynamics_2["p"], node_ranges=[(0, n_1 - 1), (n_2 - 1, n)]
)

v_dynamics_1_to_2 = ox.Cond(
    None, dynamics_1["v"], dynamics_2["v"], node_ranges=[(0, n_1 - 1), (n_2 - 1, n)]
)
...
problem.algorithm.k_max = 50
problem.algorithm.ep_tr = 1e-8
problem.algorithm.ep_vc = 1e-8
