...
def test_calculate_nonlinear_penalty_no_constraints(settings, empty_nodal_constraints):
    ...
    nonlinear_cost, nonlinear_penalty, nodal_penalty = AutotuningBase.calculate_nonlinear_penalty(
        x_prop, x_bar, u_bar, lam_vc, lam_vb, lam_cost,
        empty_nodal_constraints, params, settings
    )
...
def test_calculate_nonlinear_penalty_with_nodal_violations(
    ...
    nonlinear_cost, nonlinear_penalty, nodal_penalty = AutotuningBase.calculate_nonlinear_penalty(
        x_prop, x_bar, u_bar, lam_vc, lam_vb, lam_cost,
        nodal_constraints_with_violations, params, settings
    )
...
def test_calculate_nonlinear_penalty_with_cross_node_violations(
    settings, cross_node_constraints
):
    ...
    nonlinear_cost, nonlinear_penalty, nodal_penalty = AutotuningBase.calculate_nonlinear_penalty(
        x_prop, x_bar, u_bar, lam_vc, lam_vb, lam_cost,
        cross_node_constraints, params, settings
    )
