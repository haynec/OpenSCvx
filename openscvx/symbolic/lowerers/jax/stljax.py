...
def _visit_or(lowerer, node: Or):
    ...
    Args:
        node: Or expression node with predicates (Constraint or STLJaxExpr)
    ...
    Note:
        ...
        - For STLJaxExpr: recursively lower the STL expression
    ...
    Example:
        Used for task specifications like "reach goal A OR goal B"::
            ...
            task = ox.stljax.Or(goal_A, goal_B)
    ...
    from openscvx.symbolic.expr.stljax import STLJaxExpr
    ...
    for pred in node.predicates:
        ...
        elif isinstance(pred, STLJaxExpr):
